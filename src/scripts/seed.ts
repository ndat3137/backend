      ...
      products: [
        {
          ...
          description:
            "This wireless mouse offers a smooth navigation experience with a multi-touch surface. It features a rechargeable battery that lasts up to a month and pairs automatically with compatible devices. Includes a USB-C charging cable for convenience.",
          weight: 400,
          status: ProductStatus.PUBLISHED,
          images: [
            {
      ...
      products: [
        {
          ...
          description:
            "Unleash your gaming potential with this 15.6-inch gaming laptop. Powered by an NVIDIA RTX 4080 GPU and a 240Hz QHD display, it delivers stunning visuals and smooth performance. Equipped with advanced cooling technology and RGB backlit keyboard, this laptop is designed for immersive gaming experiences.",
          weight: 450,
          status: ProductStatus.PUBLISHED,
          images: [
            {
